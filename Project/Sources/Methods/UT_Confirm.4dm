...
// Date and time : 10/10/23, 10:17:33
// -------------------------------------------------------------------------------------------------
C_OBJECT:C1216($1; $oMessageParam)

$oMessageParam:=$1

var $oFormLayout; $oFormObject; $oPage; $oMessage; $oBtnAccept; $oBtnCancel; $oRectangle : Object
...
var $tWindowTitle; $tMessage; $tTextFont; $tOK; $tCancel : Text
var $bTextBold; $bTextCenter : Boolean

$iFormWidth:=500
$iFormHeight:=120
$tWindowTitle:="Confirm"
$tOK:="Ok"
$tCancel:="Cancel"
...
End if 
If ($oMessageParam.tOK#Null:C1517)
	$tOK:=$oMessageParam.tOK
End if 
If ($oMessageParam.tCancel#Null:C1517)
	$tCancel:=$oMessageParam.tCancel
End if 
...
OB SET:C1220($oRectangle; "stroke"; "transparent")
...
OB SET:C1220($oBtnAccept; "left"; $iFormWidth-110)
OB SET:C1220($oBtnAccept; "width"; 100)
...
OB SET:C1220($oBtnAccept; "text"; $tOK)
...
$oBtnCancel:=New object:C1471  // "btnCancel"
OB SET:C1220($oBtnCancel; "type"; "button")
OB SET:C1220($oBtnCancel; "top"; $iFormHeight-(20+8))
OB SET:C1220($oBtnCancel; "left"; 10)
OB SET:C1220($oBtnCancel; "width"; 100)
OB SET:C1220($oBtnCancel; "height"; 20)
OB SET:C1220($oBtnCancel; "sizingX"; "none")
OB SET:C1220($oBtnCancel; "sizingY"; "none")
OB SET:C1220($oBtnCancel; "action"; "cancel")
OB SET:C1220($oBtnCancel; "text"; $tCancel)
OB SET:C1220($oBtnCancel; "class"; "")
OB SET:C1220($oBtnCancel; "focusable"; False:C215)
OB SET:C1220($oBtnCancel; "defaultButton"; False:C215)
OB SET:C1220($oBtnCancel; "events"; New collection:C1472("onClick"))

$oPage:=New object:C1471
OB SET:C1220($oPage; "objects"; New object:C1471("rectangle"; $oRectangle; "tMessage"; $oMessage; "btnCancel"; $oBtnCancel; "btnAccept"; $oBtnAccept))
...
//OB SET($oFormLayout; "method"; "UT_Confirm_FormMethod")
