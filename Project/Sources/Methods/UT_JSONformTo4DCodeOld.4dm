//%attributes = {}
// -------------------------------------------------------------------------------------------------
// Method name   : UT_JSONformTo4DCodeOld
// Description
// 
//
// Parameters
...
If (ok=1)
	...
	Else 
		...
		If (Size of array:C274($atPropertyNames)>0)
			...
			For ($iCntrAttr; 1; Size of array:C274($atPropertyNames))
				...
				Case of 
					: ($aiPropertyTypes{$iCntrAttr}=Is object:K8:27)
						$tResultText:=$tResultText+"OB SET ($oFormObject;"+Char:C90(Double quote:K15:41)+$tAttributeName+Char:C90(Double quote:K15:41)+"; New object())"+Char:C90(Carriage return:K15:38)
					...
					: ($aiPropertyTypes{$iCntrAttr}=Is collection:K8:32)
						Case of 
							...
							: ($tAttributeName="pages")
								$tResultText:=$tResultText+"OB SET ($oFormObject;"+Char:C90(Double quote:K15:41)+$tAttributeName+Char:C90(Double quote:K15:41)+"; New collection())"+Char:C90(Carriage return:K15:38)
							...
							: ($tAttributeName="events")
								...
								$tResultText:=$tResultText+"OB SET ($oFormObject;"+Char:C90(Double quote:K15:41)+$tAttributeName+Char:C90(Double quote:K15:41)+"; New collection("+$tEventList+"))"+Char:C90(Carriage return:K15:38)
					...
					: ($aiPropertyTypes{$iCntrAttr}=Is real:K8:4)
						$tResultText:=$tResultText+"OB SET ($oFormObject;"+Char:C90(Double quote:K15:41)+$tAttributeName+Char:C90(Double quote:K15:41)+";"+String:C10($oFormObjectOrig[$tAttributeName])+")"+Char:C90(Carriage return:K15:38)
					...
					: ($aiPropertyTypes{$iCntrAttr}=Is text:K8:3)
						...
						If ($tAttributeName="method")
							If ($tMethodName#"")
								$tResultText:=$tResultText+"OB SET ($oFormObject;"+Char:C90(Double quote:K15:41)+"method"+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$tMethodName+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
							Else 
								$tResultText:=$tResultText+"OB SET ($oFormObject;"+Char:C90(Double quote:K15:41)+$tAttributeName+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$oFormObjectOrig[$tAttributeName]+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
							End if 
						Else 
							$tResultText:=$tResultText+"OB SET ($oFormObject;"+Char:C90(Double quote:K15:41)+$tAttributeName+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$oFormObjectOrig[$tAttributeName]+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
						End if 
					...
					If (Size of array:C274($atPropertyNames)>0)
						...
						For ($iCntrAttr; 1; Size of array:C274($atPropertyNames))
							...
							Case of 
												...
												If (Size of array:C274($atPropertyNamesGroups)>0)
													...
													For ($iCntrGroup; 1; Size of array:C274($atPropertyNamesGroups))
														...
														For each ($tElement; $oObjectTemp2[$atPropertyNamesGroups{$iCntrGroup}])
															...
															End if 
														End for each 
														$tResultText:=$tResultText+"OB SET ($oFormSubObjectGroups;"+Char:C90(Double quote:K15:41)+$atPropertyNamesGroups{$iCntrGroup}+Char:C90(Double quote:K15:41)+"; New collection("+$tEventList+"))"+Char:C90(Carriage return:K15:38)
														
													End for 
													
													$tResultText:=$tResultText+"OB SET ($oFormSubObject;"+Char:C90(Double quote:K15:41)+$tAttributeName2+Char:C90(Double quote:K15:41)+";$oFormSubObjectGroups)"+Char:C90(Carriage return:K15:38)
								...
								: ($aiPropertyTypes{$iCntrAttr}=Is real:K8:4)
									$tResultText:=$tResultText+"OB SET ($oFormSubObject;"+Char:C90(Double quote:K15:41)+$tAttributeName2+Char:C90(Double quote:K15:41)+";"+String:C10($oObjectTemp[$tAttributeName2])+")"+Char:C90(Carriage return:K15:38)
								...
								: ($aiPropertyTypes{$iCntrAttr}=Is text:K8:3)
									...
									If ($tAttributeName2="method")
										If ($tMethodName#"")
											$tResultText:=$tResultText+"OB SET ($oFormSubObject;"+Char:C90(Double quote:K15:41)+"method"+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$tMethodName+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
										Else 
											$tResultText:=$tResultText+"OB SET ($oFormSubObject;"+Char:C90(Double quote:K15:41)+$tAttributeName2+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$oObjectTemp[$tAttributeName2]+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
										End if 
									Else 
										$tResultText:=$tResultText+"OB SET ($oFormSubObject;"+Char:C90(Double quote:K15:41)+$tAttributeName2+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$oObjectTemp[$tAttributeName2]+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
									End if 
						...
						$tResultText:=$tResultText+"OB SET($oFormObject;"+Char:C90(Double quote:K15:41)+$tAttributeName+Char:C90(Double quote:K15:41)+";$oFormSubObject)"+Char:C90(Carriage return:K15:38)+Char:C90(Carriage return:K15:38)
				...
				Else 
					...
					For ($iCntrObj; 1; Size of array:C274($atPropertyNames))
						...
						If ($aiPropertyTypes{$iCntrObj}=Is object:K8:27)  // these are form objects, so only objects to process
							...
							For ($iCntrAttr; 1; Size of array:C274($atPageObjectPropertyNames))
								...
								Case of 
									...
									: ($aiPageObjectPropertyTypes{$iCntrAttr}=Is real:K8:4)
										$tResultText:=$tResultText+"OB SET ($oPageObject;"+Char:C90(Double quote:K15:41)+$tAttributeName2+Char:C90(Double quote:K15:41)+";"+String:C10($oObjectTemp[$tAttributeName2])+")"+Char:C90(Carriage return:K15:38)
									...
									: ($aiPageObjectPropertyTypes{$iCntrAttr}=Is text:K8:3)
										...
										If ($tAttributeName2="method")
											If ($tMethodName#"")
												$tResultText:=$tResultText+"OB SET ($oPageObject;"+Char:C90(Double quote:K15:41)+"method"+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$tMethodName+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
											Else 
												$tResultText:=$tResultText+"OB SET ($oPageObject;"+Char:C90(Double quote:K15:41)+$tAttributeName2+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$oObjectTemp[$tAttributeName2]+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
											End if 
										Else 
											$tResultText:=$tResultText+"OB SET ($oPageObject;"+Char:C90(Double quote:K15:41)+$tAttributeName2+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$oObjectTemp[$tAttributeName2]+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
										End if 
									...
									: ($aiPageObjectPropertyTypes{$iCntrAttr}=Is object:K8:27)
										...
										Case of 
											: ($tAttributeName2="tooltip") | ($tAttributeName2="numberFormat") | ($tAttributeName2="entryFilter") | ($tAttributeName2="textFormat") | ($tAttributeName2="choiceList")
												...
												$tResultText:=$tResultText+"OB SET ($oPageObject;"+Char:C90(Double quote:K15:41)+$tAttributeName2+Char:C90(Double quote:K15:41)+";New object("+Char:C90(Double quote:K15:41)+$atObjectTemp2PropertyNames{1}+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$oObjectTemp2[$atObjectTemp2PropertyNames{1}]+Char:C90(Double quote:K15:41)+"))"+Char:C90(Carriage return:K15:38)
									...
									: ($aiPageObjectPropertyTypes{$iCntrAttr}=Is collection:K8:32)
										If (($oObjectTemp.type="listbox") & ($tAttributeName2="columns"))
											$tResultText:=$tResultText+"OB SET ($oPageObject;"+Char:C90(Double quote:K15:41)+$tAttributeName2+Char:C90(Double quote:K15:41)+";New collection)"+Char:C90(Carriage return:K15:38)
											$tResultText:=$tResultText+"//+++++++++++++++++++++++++++"+Char:C90(Carriage return:K15:38)
												...
												For ($iCntrColumnAttr; 1; Size of array:C274($atColumnPropertyNames))
													...
													Case of 
														...
														: ($aiColumnPropertyTypes{$iCntrColumnAttr}=Is real:K8:4)
															$tResultText:=$tResultText+"OB SET ($oColumnObj;"+Char:C90(Double quote:K15:41)+$tColumnAttributeName+Char:C90(Double quote:K15:41)+";"+String:C10($oColumn[$tColumnAttributeName])+")"+Char:C90(Carriage return:K15:38)
															
														: ($aiColumnPropertyTypes{$iCntrColumnAttr}=Is boolean:K8:9)
															$tResultText:=$tResultText+"OB SET ($oColumnObj;"+Char:C90(Double quote:K15:41)+$tColumnAttributeName+Char:C90(Double quote:K15:41)+";"+String:C10($oColumn[$tColumnAttributeName])+")"+Char:C90(Carriage return:K15:38)
															
														: ($aiColumnPropertyTypes{$iCntrColumnAttr}=Is text:K8:3)
															$tResultText:=$tResultText+"OB SET ($oColumnObj;"+Char:C90(Double quote:K15:41)+$tColumnAttributeName+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$oColumn[$tColumnAttributeName]+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
														...
														: ($aiColumnPropertyTypes{$iCntrColumnAttr}=Is object:K8:27)
															...
															For ($iCntrColumnObjAttr; 1; Size of array:C274($atColumnObjectPropertyNames))
																...
																Case of 
																	: ($aiColumnObjectPropertyTypes{$iCntrColumnObjAttr}=Is real:K8:4)
																		$tResultText:=$tResultText+"OB SET ($oObjectTemp;"+Char:C90(Double quote:K15:41)+$tAttributeName3+Char:C90(Double quote:K15:41)+";"+String:C10($oObjectTemp[$tAttributeName3])+")"+Char:C90(Carriage return:K15:38)
																	...
																	: ($aiColumnObjectPropertyTypes{$iCntrColumnObjAttr}=Is text:K8:3)
																		...
																		If ($tAttributeName3="method")
																			If ($tMethodName#"")
																				$tResultText:=$tResultText+"OB SET ($oObjectTemp;"+Char:C90(Double quote:K15:41)+"method"+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$tMethodName+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
																			Else 
																				$tResultText:=$tResultText+"OB SET ($oObjectTemp;"+Char:C90(Double quote:K15:41)+$tAttributeName3+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$oObjectTemp[$tAttributeName3]+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
																			End if 
																		Else 
																			$tResultText:=$tResultText+"OB SET ($oObjectTemp;"+Char:C90(Double quote:K15:41)+$tAttributeName3+Char:C90(Double quote:K15:41)+";"+Char:C90(Double quote:K15:41)+$oObjectTemp[$tAttributeName3]+Char:C90(Double quote:K15:41)+")"+Char:C90(Carriage return:K15:38)
																		End if 
															...
															$tResultText:=$tResultText+"OB SET ($oColumnObj;"+Char:C90(Double quote:K15:41)+$tColumnAttributeName+Char:C90(Double quote:K15:41)+";$oObjectTemp)"+Char:C90(Carriage return:K15:38)
														...
														: ($aiColumnPropertyTypes{$iCntrColumnAttr}=Is collection:K8:32)
															...
															$tResultText:=$tResultText+"OB SET ($oColumnObj;"+Char:C90(Double quote:K15:41)+$tColumnAttributeName+Char:C90(Double quote:K15:41)+"; New collection("+$tEventList+"))"+Char:C90(Carriage return:K15:38)
											...
											$tResultText:=$tResultText+"OB SET($oPageObject;"+Char:C90(Double quote:K15:41)+"columns"+Char:C90(Double quote:K15:41)+";$colColumns)"+Char:C90(Carriage return:K15:38)
										...
										Else 
											...
											$tResultText:=$tResultText+"OB SET ($oPageObject;"+Char:C90(Double quote:K15:41)+$tAttributeName2+Char:C90(Double quote:K15:41)+"; New collection("+$tEventList+"))"+Char:C90(Carriage return:K15:38)
							...
							$tResultText:=$tResultText+"OB SET ($oObjects;"+Char:C90(Double quote:K15:41)+$tAttributeName+Char:C90(Double quote:K15:41)+"; $oPageObject)"+Char:C90(Carriage return:K15:38)
						Else 
			...
			//$tResultText:=$tResultText+"$oFormObject.tMyFormPath:="+Char(Double quote)+$tFormPath+Char(Double quote)+Char(Carriage return)
