...
// Date and time : 03/20/23, 10:09:04
// -------------------------------------------------------------------------------------------------
...
If ((Count parameters:C259=0) & (FORM Event:C1606=Null:C1517))  // this is the entry point in the method, like a "menu method" - no params
	...
	$tHelpTxt:=$tHelpTxt+"<button class=\"tablinks\" onclick=\"openTab(event, 'FieldProps')\">Field properties</button>"
	$tHelpTxt:=$tHelpTxt+"<button class=\"tablinks\" onclick=\"openTab(event, 'Workflow')\">Workflow</button></div>"
	...
	$tHelpTxt:=$tHelpTxt+"</div>"
	$tHelpTxt:=$tHelpTxt+"<div id=\"Workflow\" class=\"tabcontent\">"
	$tHelpTxt:=$tHelpTxt+"<h3>Workflow</h3>"
	$tHelpTxt:=$tHelpTxt+"<p>The method 'UT_Catalog_View' contains all the code needed to show all the information of the catalog file.</p>"
	$tHelpTxt:=$tHelpTxt+"<p>As such, this methode is the only thing you need to copy to your structure in order to have all the</p>"
	$tHelpTxt:=$tHelpTxt+"<p>functionality. You can even rename the method to any name to your liking.</p>"
	$tHelpTxt:=$tHelpTxt+"<p>Should you make changes to the form 'UT_Catalog_View', you can automate how those changes make it</p>"
	$tHelpTxt:=$tHelpTxt+"<p>into the method 'UT_Catalog_View' by running the method 'UT_JSONFormTO4DCode'.</p>"
	$tHelpTxt:=$tHelpTxt+"<p>Running that method gives you the option to either:</p>"
	$tHelpTxt:=$tHelpTxt+"<p>-&nbsp&nbspCopy the generated code from the pasteboard manually into the method.</p>"
	$tHelpTxt:=$tHelpTxt+"<p>-&nbsp&nbspHave the generated code pasted automatically into the method.</p>"
	$tHelpTxt:=$tHelpTxt+"<p>-&nbsp&nbspHave the generated code pasted automatically into the method AND compare the JSON file of the</p>"
	$tHelpTxt:=$tHelpTxt+"<p>&nbsp&nbsp&nbsp original form created by the form editor and the JSON object resulting from the generated code.</p>"
	$tHelpTxt:=$tHelpTxt+"<p>&nbsp&nbsp&nbsp (It is assumed that you have BBEDIT on your system to run the comparison.)</p>"
	$tHelpTxt:=$tHelpTxt+"<p>You can of course also decide to use the project as a component, in which case you can remove the code</p>"
	$tHelpTxt:=$tHelpTxt+"<p>for generating both form objects from the method 'UT_Catalog_View' (keep 2 last subroutines but remove</p>"
	$tHelpTxt:=$tHelpTxt+"<p>the code within them). In that case the JSON files generated by the form editor for both forms will be used.</p>"
	$tHelpTxt:=$tHelpTxt+"</div>"
	...
	EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "CreateFormLayoutObject"; "oFormLayout"; $oFormLayout))
			...
			If (Form:C1466.tFormName="UT_Catalog_View")
				Case of 
					...
					: (FORM Event:C1606.code=On Outside Call:K2:11)
						...
						EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "SelectCatalog"; "oReturn"; $oReturn))
						
						If ($oReturn.ok=1)
							// +++++++++++++++++++++++++++++++++++++++ Begin parse catalog +++++++++++++++++++++++++++++++++++
							
							$oCatalog:=New object:C1471
							EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "ProcessCatalogFile"; "document"; $oReturn.tDocument; "oCatalog"; $oCatalog; "oReturn"; $oReturn))
							If ($oReturn.ok#1)
								CANCEL:C270
							...
							Else 
								...
								EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "InitFilterVariables"))
								EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "InitCollections"))
				...
				End case 
			Else   // form name = "UT_Catalog_Help"
				Case of 
					: (FORM Event:C1606.code=On Close Box:K2:21)
						CANCEL:C270
			...
			Case of 
				: (FORM Event:C1606.objectName="btnClearTablesFilter")
					...
					If ($pPtr->#"")
						...
						EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "ShowTable"; "tTableToShow"; Form:C1466.colTables[0].name))
				...
				: (FORM Event:C1606.objectName="btnClearRelationsFilter")
					...
					If ($pPtr->#"")
						...
						EXECUTE METHOD:C1007(Current method name:C684; *; $oParam)
				...
				: (FORM Event:C1606.objectName="btnClearIndexesFilter")
					...
					If ($pPtr->#"")
						...
						EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "ShowIndexes"; "tTableToShow"; Form:C1466.colIndexesAll[0].tableName))
					...
					Case of 
						: (Form event code:C388=On Clicked:K2:4)
							...
							If (Not:C34($bHelpWindowIsOpen))
								...
								$oFormLayout:=New object:C1471
								EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "CreateFormLayoutObjectHelp"; "oFormLayout"; $oFormLayout))
				...
				: (FORM Event:C1606.objectName="FilterValueTables")
					Case of 
						: (Form event code:C388=On After Keystroke:K2:26)
							...
							EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "DoFilter"; "tFilterObjectName"; FORM Event:C1606.objectName))
					...
					Case of 
						...
						: (FORM Event:C1606.code=On Double Clicked:K2:5)
							If ($iRow>0)
								...
								EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "ShowIndexes"; "tTableToShow"; Form:C1466.currentTable.name))
				...
				: (FORM Event:C1606.objectName="btnDestinationTable") | (FORM Event:C1606.objectName="btnSourceTable")
					If (FORM Event:C1606.code=On Clicked:K2:4)
						If (FORM Event:C1606.objectName="btnDestinationTable")
							If (Form:C1466.tDestinationTable#"")
								EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "ShowTable"; "tTableToShow"; Form:C1466.tDestinationTable))
							End if 
						Else 
							If (Form:C1466.tSourceTable#"")
								EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "ShowTable"; "tTableToShow"; Form:C1466.tSourceTable))
							End if 
						End if 
					End if 
					...
					Case of 
						: (FORM Event:C1606.code=On Selection Change:K2:29)
							If ($iRow>0)
								...
								EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "ShowIndexes"; "tTableToShow"; Form:C1466.currentTable3.name))
							End if 
							
						: (FORM Event:C1606.code=On Double Clicked:K2:5)
							If ($iRow>0)
								EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "ShowTable"; "tTableToShow"; Form:C1466.currentTable3.name))
							End if 
		...
		If ($oParam.tSubroutine#Null:C1517)
			Case of 
					...
					Repeat 
						...
						Else 
							Case of 
								...
								: ($tName="relation")
									EXECUTE METHOD:C1007(Current method name:C684; *; New object:C1471("tSubroutine"; "ProcessRelation"; "node"; $tXMLElementRef; "collection"; $colRelations))
				...
				: ($oParam.tSubroutine="CreateFormLayoutObject")
					// ** Begin generated code for form UT_Catalog_View
					If (True:C214)
					...
					End if 
					// ** End generated code for form UT_Catalog_View
					
					
				: ($oParam.tSubroutine="CreateFormLayoutObjectHelp")
					// ** Begin generated code for form UT_Catalog_Help
					If (True:C214)
						var $colColumns; $colEntryOrder : Collection
						var $oFormObject; $oFormSubObject; $oPageObject; $oObjects; $oColumns; $oColumnObj; $oObjectTemp : Object
					...
					End if 
					// ** End generated code for form UT_Catalog_Help
